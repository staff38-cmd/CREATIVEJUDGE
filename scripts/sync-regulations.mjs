...
- "注釈・表記ルール": 注釈の視認性・サイズ・配置・必須注釈文言（「注釈が見えない」「注釈要」「※〜の表記が必要」など）
- "媒体ガイドライン": 特定媒体固有のルール

${rowsText}

JSONのみ出力（\`\`\`不要）:
{"rules":[{"title":"タイトル","description":"NG理由","category":"過去NG事例"|"企業レギュレーション"|"薬機法"|"景品表示法"|"注釈・表記ルール"|"媒体ガイドライン","quote":"NG表現","sourceRow":行番号}]}`;
